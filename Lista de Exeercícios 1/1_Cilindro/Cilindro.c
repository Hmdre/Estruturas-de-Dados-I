...
Cilindro* criaCilindro (float x1, float y1, float z1, float x2, float y2, float z2, float raio) //aloca um cilindro.
{
    ...
    cilindro->pontoUm.x = x1;
	cilindro->pontoUm.y = y1;
    cilindro->pontoUm.z = z1;
    cilindro->pontoDois.x = x2;
	cilindro->pontoDois.y = y2;
    cilindro->pontoDois.z = z2;
	cilindro->raioUm = raio;
